...
\IEEEPARstart{F}{ür} Kategorische-Attribute existiert die die Summe der Unterschiede als Distanzfunktion, 
...
\centering
\label{p1-3 k-means}
\hspace{-4em}\scalebox{1.1}{\input{../beamer/img/kmeans1.tikz}}
\caption{Phase 1--3 k-means}
\end{figure}
\begin{figure}
\centering
\label{p4 k-means}
\hspace{-4em}\scalebox{1.1}{\input{../beamer/img/kmeans3.tikz}}
\caption{Phase 4 k-means}
\end{figure}
\begin{figure}
\centering
\label{p5 k-means}
\hspace{-4em}\scalebox{1.1}{\input{../beamer/img/kmeans2.tikz}}
\caption{Phase 5 k-means}
\end{figure}
\begin{figure}
\centering
\label{p6 k-means}
\hspace{-4em}\scalebox{1.1}{\input{../beamer/img/kmeans4.tikz}}
\caption{Phase 6 und 2 k-means}
\end{figure}
