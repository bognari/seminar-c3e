...
Die Unterscheidung ob ein Objekt ein Stern, eine Galaxie oder etwas Unbekanntes ist, lässt sich
...
Das Paper \cite{wu2008top} von Xindong Wu und weiteren mit dem Titel \emph{Top 10 Algorithms in Data Mining} wurde 
...
Für KDD werden die Daten homogenisiert und dann mittels eines Data Mining Algorithmuses verarbeitet, sodass \enquote{Wissen} 
entsteht. 
...
Die Idee von KKD ist \emph{Wissen} durch \emph{Daten} und wird nach Fayyad \cite{fayyad1996data} wie folgt definiert: \begin{quote}
...
\end{quote} 
Data Mining wird in der Forschung, Vermarktung, Medizin, (Wetter-) Vorhersagen,
Betrugsaufklärung usw. eingesetzt.
