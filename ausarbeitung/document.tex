...
\IEEEPARstart{F}{ür} nummerische Attribute existieren die beispielhaften Distanzfunktionen (siehe Formeln \ref{dist1} -- \ref{dist4}) und für 
...
\IEEEPARstart{U}{m} den Sachverhalt zu verdeutlichen wird folgendes Beispiel aus dem Buch \cite{ester2000knowledge} genutzt. In Tabelle \ref{dataass} ist eine Transaktionsdatenbank
...
\IEEEPARstart{B}{ig Data} verschiebt die Schwierigkeit von der Datenbeschaffung zur Datenauswertung. 
