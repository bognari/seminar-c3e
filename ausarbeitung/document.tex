...
\begin{IEEEkeywords}
Data Mining, Big Data, Clustering, Clustering, Assoziation, Support Vector Machines, k-means
\end{IEEEkeywords}}
...
\begin{align}
\intertext{Euklidische-Distanz:\vspace{-1em}}
\dist(x,y) &= \sqrt{(x_1 - y_1)^2 + \ldots + (x_n - y_n)^2}\\
\intertext{Manhattan-Distanz:\vspace{-1em}}
\dist(x,y) &= |x_1 - y_1| + \ldots + |x_n - y_n|\\
\intertext{Maximum-Metrik:\vspace{-1em}} 
\dist(x,y) &= \max\big(|x_1 - y_1| + \ldots + |x_n - y_n|\big)\\
\intertext{Alg. $L_p$-Metrik:\vspace{-1em}}
