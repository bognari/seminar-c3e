...
\begin{columns}[onlytextwidth]
    \column{0.5\textwidth}
		\begin{enumerate}[label=\bfseries\arabic*.]
		\item \textbf{C4.5} und ähnliche %clu
		\item \textbf{k-means} %clu
		\item Suport Vector Machines %clas
		\item Apriori %asso
		\item \textbf{EM Algorithm} %clu
		\end{enumerate}
    \column{0.5\textwidth}
	    \begin{enumerate}[label=\bfseries\arabic*.]
	    \setcounter{enumi}{5}
	    \item PageRank
	    \item AdaBoost %cla
	    \item k-nearest neighbor %cla
	    \item Naive Bayes %cla
	    \item \textbf{CART} %clu
	    \end{enumerate}
\end{columns}
\end{frame}
...
\begin{figure}
\scalebox{.7}{\input{img/svm1.tikz}}
...
\begin{columns}[onlytextwidth]
    \column{0.5\textwidth}
		\begin{enumerate}[label=\bfseries\arabic*.]
		\item C4.5 und ähnliche %clu
		\item k-means %clu
		\item \textbf{Suport Vector Machines} %clas
		\item Apriori %asso
		\item EM Algorithm %clu
		\end{enumerate}
    \column{0.5\textwidth}
	    \begin{enumerate}[label=\bfseries\arabic*.]
	    \setcounter{enumi}{5}
	    \item PageRank
	    \item \textbf{AdaBoost} %cla
	    \item \textbf{k-nearest neighbor} %cla
	    \item \textbf{Naive Bayes} %cla
	    \item CART %clu
	    \end{enumerate}
\end{columns}
\end{frame}
...
%\begin{itemize} 
%\item Skaliert mit den Daten nach dem HACE Theorem
%\item 
%\end{itemize}
\begin{figure}
